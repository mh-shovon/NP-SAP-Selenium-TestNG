package TestRunners.BusCompanyManageTestRunners.CounterTestRunner;

import BusCompany.Counter.EditCounter;
...
public class EditCounterTestRunner extends Setup {
    ...
    public void editCounterTest() throws InterruptedException {

...
//    List<WebElement> countermanAddress;
    ...
    public void createNewCounterman() throws InterruptedException {
        ...
        Thread.sleep(1000);
        countermanName.get(0).sendKeys("Automation Counterman-2");
        Thread.sleep(1000);
        countermanPhone.get(1).sendKeys("01888000206");
        Thread.sleep(1000);
//        countermanEmail.get(2).sendKeys("automation@gmail.com");
//        Thread.sleep(1000);
        countermanPassword.get(3).sendKeys("01888000206");
        Thread.sleep(1000);
        ...
        Thread.sleep(1000);
//        countermanNid.get(5).sendKeys("01888000206");
//        Thread.sleep(1000);

package TestRunner.TabTripsTestRunners;
...
public class FilterTripTestRunner extends Setup {
    ...
    @Test(priority = 2, description = "Filter trips without any data")
    ...
    @Test(priority = 2, description = "Filter trips with operator")
    ...
    @Test(priority = 3, description = "Filter trips with operator and both from and to stoppage")
    ...
    @Test(priority = 4, description = "Filter trips with operator and active status")
    ...
    @Test(priority = 5, description = "Filter trips with operator and inactive status")
    ...
    @Test(priority = 6, description = "Filter trips with operator and trip no")
